...
<h3>Filter:</h3>
<div>
  <select class="form-select filter-dropdown category common" aria-label="Default select example" id="category">
...
<div>
  <select class="form-select filter-dropdown batch common" aria-label="Default select example" id="batch" disabled>
