            ...
            <div class="row w-100">
                ...
                <div class="col-md-3">
                    <div class="card border-success mx-sm-1 p-3">
                        ...
                        <div class="text-success text-center mt-3"><h4>Something</h4></div>
                ...
                <div class="col-md-3">
                    <div class="card border-danger mx-sm-1 p-3">
                        ...
                        <div class="text-danger text-center mt-3"><h4>Something </h4></div>
                ...
                <div class="col-md-3">
                    <div class="card border-warning mx-sm-1 p-3">
                        ...
                        <div class="text-warning text-center mt-3"><h4>Something</h4></div>
